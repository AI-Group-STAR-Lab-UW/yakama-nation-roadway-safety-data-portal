...
FormParamsConstants.AreaSafetyIndex = {
  formTitle: 'Intersection Safety Index Visualization',
  ...
  uiList: [
    ...
    },
    {
      ...
      value: {
        ...
        defaultOption: [{ label: 'Saturday', value: 'Saturday' }],
      },
    },
    {
      name: 'Roadway Class',
  ...
  defaultUiList: {
    ...
    'Weekday(s)': ['Saturday'],
    'Roadway Class': ['(04) Urban Multilane Divided Non Freeways'],
    Severity: ['(7) Possible Injury'],
  },
};
